class BBPSecurityGlassA extends BBPDestruction;

defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         UseDirectionAs=PTDU_Right
         Acceleration=(Z=-998.000000)
         ...
         AutoDestroy=True
         StartLocationRange=(X=(Min=-128.000000,Max=128.000000),Z=(Min=-64.000000,Max=64.000000))
         ...
         Name="SpriteEmitter0"
     End Object
     Emitters(0)=SpriteEmitter'BBParticles.BBPSecurityGlassA.SpriteEmitter0'
     AutoDestroy=True
     bNoDelete=False
     bUnlit=False
}
