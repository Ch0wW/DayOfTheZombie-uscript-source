class BBPWoodenDoorMaleLTD extends BBPDoors;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter10
         StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTDPieceA'
         ...
         Name="MeshEmitter10"
     End Object
     Emitters(0)=MeshEmitter'BBParticles.BBPWoodenDoorMaleLTD.MeshEmitter10'
     Begin Object Class=MeshEmitter Name=MeshEmitter11
         StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTDPieceB'
         Acceleration=(Z=-900.000000)
         MaxParticles=1
         RespawnDeadParticles=False
         AutoDestroy=True
         ...
         Name="MeshEmitter11"
     End Object
     Emitters(1)=MeshEmitter'BBParticles.BBPWoodenDoorMaleLTD.MeshEmitter11'
     Begin Object Class=MeshEmitter Name=MeshEmitter12
         StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTDPieceC'
         Acceleration=(Z=-900.000000)
         MaxParticles=1
         RespawnDeadParticles=False
         AutoDestroy=True
         ...
         Name="MeshEmitter12"
     End Object
     Emitters(2)=MeshEmitter'BBParticles.BBPWoodenDoorMaleLTD.MeshEmitter12'
     Begin Object Class=MeshEmitter Name=MeshEmitter13
         StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTDPieceD'
         Acceleration=(Z=-900.000000)
         MaxParticles=1
         RespawnDeadParticles=False
         AutoDestroy=True
         ...
         Name="MeshEmitter13"
     End Object
     Emitters(3)=MeshEmitter'BBParticles.BBPWoodenDoorMaleLTD.MeshEmitter13'
     Begin Object Class=MeshEmitter Name=MeshEmitter14
         ...
         Name="MeshEmitter14"
     End Object
     Emitters(4)=MeshEmitter'BBParticles.BBPWoodenDoorMaleLTD.MeshEmitter14'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         Name="SpriteEmitter3"
     End Object
     Emitters(5)=SpriteEmitter'BBParticles.BBPWoodenDoorMaleLTD.SpriteEmitter3'
     AutoDestroy=True
     bNoDelete=False
}
