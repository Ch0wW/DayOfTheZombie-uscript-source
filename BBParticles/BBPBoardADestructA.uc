class BBPBoardADestructA extends BBPDestruction;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         StaticMesh=StaticMesh'DOTZSIndustrial.Breakable.BoardAPieceC'
         ...
         Name="MeshEmitter0"
     End Object
     Emitters(0)=MeshEmitter'BBParticles.BBPBoardADestructA.MeshEmitter0'
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         StaticMesh=StaticMesh'DOTZSIndustrial.Breakable.BoardAPieceE'
         Acceleration=(Z=-1000.000000)
         MaxParticles=5
         RespawnDeadParticles=False
         StartLocationRange=(X=(Max=100.000000),Z=(Max=2.000000))
         SpinParticles=True
         SpinsPerSecondRange=(X=(Min=-1.000000,Max=1.000000),Y=(Min=-1.000000,Max=1.000000),Z=(Min=-1.000000,Max=1.000000))
         DampRotation=True
         ...
         Name="MeshEmitter1"
     End Object
     Emitters(1)=MeshEmitter'BBParticles.BBPBoardADestructA.MeshEmitter1'
     AutoDestroy=True
     bNoDelete=False
     bUnlit=False
     Tag="BBPBoardADestructA"
}
