 ...
 *****************************************************************
 */
class OtisRevolverWeapon extends DOTZGunWeapon
    config(user);
...
defaultproperties
{
     PawnAnimationPackage="DOTZAHumans.3POtisRevolver"
     FireAnimName="OtisRevolverFire"
     StandIdleAnimName="OtisRevolverStandIdle"
     CrouchIdleAnimName="OtisRevolverCrouchIdle"
     HitAnimName="OtisRevolverHit"
