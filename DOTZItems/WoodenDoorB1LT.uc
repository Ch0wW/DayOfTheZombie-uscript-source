...
// September 27, 2005
class WoodenDoorB1LT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoorB1LTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1LTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorB1LTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1LTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1LTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1LTA'
