...
// September 27, 2005
class WoodenDoorB4RT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoorB4RTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4RTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorB4RTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4RTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4RTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4RTA'
