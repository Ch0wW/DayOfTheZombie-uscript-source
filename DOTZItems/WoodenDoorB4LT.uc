...
// September 27, 2005
class WoodenDoorB4LT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoorB4LTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4LTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorB4LTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4LTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4LTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB4LTA'
