...
// September 27, 2005
class WoodenDoor2RT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoor2RTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2RTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoor2RTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2RTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2RTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2RTA'
