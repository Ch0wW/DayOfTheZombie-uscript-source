...
// September 27, 2005
class WoodenDoorB1RT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoorB1RTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1RTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorB1RTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1RTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1RTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB1RTA'
