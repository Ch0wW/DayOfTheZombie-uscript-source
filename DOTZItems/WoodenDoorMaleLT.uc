...
// September 27, 2005
class WoodenDoorMaleLT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoorMaleLTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorMaleLTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorMaleLTA'
