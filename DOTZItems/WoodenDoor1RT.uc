...
// September 27, 2005
class WoodenDoor1RT extends DOTZDoor
...
defaultproperties
{
     ...
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor1RTD')
