...
// September 27, 2005
class WoodenDoor1LT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoor1LTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor1LTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoor1LTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor1LTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor1LTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor1LTA'
