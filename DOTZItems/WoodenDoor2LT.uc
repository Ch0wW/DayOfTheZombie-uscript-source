...
// September 27, 2005
class WoodenDoor2LT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoor2LTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2LTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoor2LTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2LTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorLTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2LTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoor2LTA'
