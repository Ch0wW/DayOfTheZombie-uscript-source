...
// September 27, 2005
class WoodenDoorB5RT extends DOTZDoor
...
{
     DamageCapacity=100
     DestructionEmitter=Class'BBParticles.BBPWoodenDoorB5RTD'
     DamageEffects(0)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=90,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB5RTB')
     DamageEffects(1)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorB5RTB',DamageRequirement=75,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB5RTC')
     DamageEffects(2)=(DamageEmitter=Class'BBParticles.BBPWoodenDoorRTDamage',DamageRequirement=40,DamageMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB5RTD')
     ...
     StaticMesh=StaticMesh'DOTZSObjects.Doors.WoodenDoorB5RTA'
