...
//@@@ Oh God! Why must the engine make me do this so?! The linking in PackageMapLevel
//of server actors to client actors is broken, good luck finding out why. I added
//these so that at least the clients could handle a single key frame. I am not proud.
var float HackKeyPosX;
var float HackKeyPosY;
var float HackKeyPosZ;
...
replication
{
	...
	reliable if( Role==ROLE_Authority )
        ...
        RealPosition, RealRotation, HackKeyPosZ, HackKeyPosX, HackKeyPosY;
}
...
simulated function Timer()
{
	...
	if ( Level.NetMode == NM_Client )
	{
            ...
            //@@@ so sorry!
        KeyPos[1].X = HackKeyPosX;
        KeyPos[1].Y = HackKeyPosY;
        KeyPos[1].Z = HackKeyPosZ;
	...
	{
        //@@@ I am so sorry!
        HackKeyPosX = KeyPos[1].X;
        HackKeyPosY = KeyPos[1].Y;
        HackKeyPosZ = KeyPos[1].Z;

		RealPosition = Location;
		RealRotation = Rotation;
	}

    //Log(HackKeyPosX $ "   " $  HackKeyPosY);
}
