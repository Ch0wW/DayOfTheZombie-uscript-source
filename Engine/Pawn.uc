...
//engine extensions by Prof J.
var bool bIsCrawling;          //in the state of crawling
var bool bWasCrawling;         //used for determining when transition occured
var byte iDamagedBoneIndex;    //for replicating bone damage
var bool bLoopingAnim;         //set animaction extension to support looping anims
var bool bAnimAgainToggle;     //extension to play the last anim again
var byte iAnimChannel;
var bool bFocused;
var bool bLastAnimAgainState;
var name NetWeaponIdle;
var string NetAddAnimPkg;
var string CurrentAddAnimPkg;
var WeaponAttachment NetAtt;
var bool FlashToggle;
var int AimedPitch;
var int iNetBodyTexture;
var int iNetHeadTexture;
...
replication
{
    ...
    reliable if( bNetDirty && (Role==ROLE_Authority) )
        bSimulateGravity, bIsCrawling, bIsCrouched, bIsWalking, bIsTyping, PlayerReplicationInfo,
        AnimAction, HitDamageType, TakeHitLocation,HeadScale,iDamagedBoneIndex, bLoopingAnim, bFocused,
        bAnimAgainToggle,iAnimChannel,NetAddAnimPkg,CurrentAddAnimPkg, NetWeaponIdle,FlashToggle,NetAtt,AimedPitch,
        iNetBodyTexture,iNetHeadTexture,xGamerTag;
