...
var vector CameraNoise;             // Like shake but, interpolated between points for smoother effect
var vector LastNoise;               // running count of the noise for calculations
var bool bUsingNoise;
