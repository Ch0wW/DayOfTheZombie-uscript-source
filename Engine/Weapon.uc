...
var     Byte    BotMode; // for compatibility with UC
...
/*****************************************************************
 * ClientWeaponSet
 * tries to set the current weapon
 *****************************************************************
 */
 ...
 *****************************************************************
 */
function WeaponSet(bool bOptionalSet)
{
    //if you are already the current weapon there is nothing to do
    if ( Instigator.Weapon == self )
        return;

    //if there is no weapon up, then this weapon is better
    ...
    if ( bOptionalSet && (Instigator.IsHumanControlled() &&
         PlayerController(Instigator.Controller).bNeverSwitchOnPickup) )
        return;
    //if the priority of this weapon is higher than the current then switch
...
state Active
{
    ...
    Log("anim end in weapon selection");
        if ( bChangeWeapon )
            GotoState('DownWeapon');
        if ( Owner == None )
        {
