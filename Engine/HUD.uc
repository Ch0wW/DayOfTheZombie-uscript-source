...
function PlayMovieScaled(String MovieFileName, float Left, float Top, float Right, float Bottom, bool UseSound, bool LoopMovie, optional bool Translucent)
{
//    StopMovie();
...
defaultproperties
{
     ...
     ProgressFontName="WarfareFonts.FontEurostile12"
     ...
     MoviePosX=100
     MoviePosY=100
     TexMovieBottom=1.000000
     TexMovieRight=1.000000
     bHidden=True
