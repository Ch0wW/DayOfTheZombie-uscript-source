...
//
//-----------------------------------------------------------
class xMeleeHeavyHoboFemale extends HeavyMeleeFemaleBase
placeable;

defaultproperties
{
     MeleeWeaponClass=Class'DOTZWeapons.LeadPipeAttachment'
     MeleePickupClass=Class'DOTZWeapons.LeadPipePickup'
