...
//
//-----------------------------------------------------------
class xMeleeHeavyMiddleAgedMale extends HeavyMeleeMaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleMiddleAged.MaleMiddleAgedBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleMiddleAged'
}
