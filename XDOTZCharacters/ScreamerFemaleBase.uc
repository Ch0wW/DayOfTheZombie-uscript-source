...
// September 27, 2005
class ScreamerFemaleBase extends ScreamerBase
    abstract notplaceable
       HideDropDown;

defaultproperties
{
     StartScreamSound=Sound'DOTZXCharacters.ZombieActivateSounds.ActiveFemaleScreamerIn'
     ContinueScreamSound=Sound'DOTZXCharacters.ZombieActivateSounds.ActiveFemaleScreamerLoop'
     EndScreamSound=Sound'DOTZXCharacters.ZombieActivateSounds.ActiveFemaleScreamerOut'
