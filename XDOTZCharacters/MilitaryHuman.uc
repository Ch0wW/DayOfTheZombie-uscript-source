...
//
//-----------------------------------------------------------
class MilitaryHuman extends PlayerPawnBase;
...
defaultproperties
{
     ...
     HeadTextures(0)=Texture'DOTZTHumans.SgtDanielTravis.SgtTravisHade01'
     HeadTextures(1)=Texture'DOTZTHumans.SgtDanielTravis.SgtTravisHade02'
     HeadTextures(2)=Texture'DOTZTHumans.SgtDanielTravis.SgtTravisHade03'
     BodyTextures(0)=Texture'DOTZTHumans.SgtDanielTravis.SgtTravisCamoBrn'
     BodyTextures(1)=Texture'DOTZTHumans.SgtDanielTravis.SgtTravisCamoGrn'
     BodyTextures(2)=Texture'DOTZTHumans.SgtDanielTravis.SgtTravisCamoGry'
     Mesh=SkeletalMesh'DOTZAHumans.SgtDanielTravis'
}
