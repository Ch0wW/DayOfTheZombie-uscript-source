...
//
//-----------------------------------------------------------
class xMeleeHeavyDoctorMale extends HeavyMeleeMaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleDoctor.MaleDoctorBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleDoctor'
}
