...
//
//-----------------------------------------------------------
class xMeleeHeavyGoreMale extends HeavyMeleeMaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleGore.MaleGoreHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleGore.MaleGoreBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleGore.MaleGoreBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleGore.MaleGoreBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleGore.MaleGoreBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleGore.MaleGoreBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleGore'
}
