...
//
//-----------------------------------------------------------
class xMeleeHeavySeniorFemale extends HeavyMeleeFemaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.FemaleSenior.FemaleSeniorBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.FemaleSenior'
}
