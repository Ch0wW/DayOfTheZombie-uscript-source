...
//
//-----------------------------------------------------------
class xMiddleAgedFemale extends StandardFemaleBase
placeable;

defaultproperties
{
     Names(0)="Tracy Baudais"
     ...
     Affectations(0)=(BoneName="Head",item=Class'DOTZItems.TeenageMaleGlasses')
     ...
     HeadTextures(0)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.FemaleMiddleAged.FemaleMiddleAgedBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.FemaleMiddleAged'
}
