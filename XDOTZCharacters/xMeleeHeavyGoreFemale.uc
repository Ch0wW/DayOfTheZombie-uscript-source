...
//
//-----------------------------------------------------------
class xMeleeHeavyGoreFemale extends HeavyMeleeFemaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.FemaleGore.FemaleGoreHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.FemaleGore.FemaleGoreBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.FemaleGore.FemaleGoreBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.FemaleGore.FemaleGoreBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.FemaleGore.FemaleGoreBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.FemaleGore.FemaleGoreBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.FemaleGore'
}
