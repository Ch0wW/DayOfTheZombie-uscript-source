...
//
//-----------------------------------------------------------
class xMeleeHeavyYoungAdultMale extends HeavyMeleeMaleBase
placeable;

defaultproperties
{
     MeleeWeaponClass=Class'DOTZWeapons.FireAxeAttachment'
     MeleePickupClass=Class'DOTZWeapons.FireAxePickup'
     Names(0)="Daniel Yu"
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleYoungAdult.MaleYoungAdultBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleYoungAdult'
}
