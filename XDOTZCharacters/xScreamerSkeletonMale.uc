...
//
//-----------------------------------------------------------
class xScreamerSkeletonMale extends ScreamerMaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleSkeleton.MaleSkeletonBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleSkeleton'
}
