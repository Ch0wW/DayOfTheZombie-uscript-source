...
//
//-----------------------------------------------------------
class xMiddleAgedMale extends StandardMaleBase
placeable;

defaultproperties
{
     Names(0)="Josh Druckman"
     ...
     Affectations(0)=(BoneName="Head",item=Class'DOTZItems.MaleMiddleAgedHat')
     Affectations(1)=(BoneName="Head",item=Class'DOTZItems.TeenageMaleGlasses')
