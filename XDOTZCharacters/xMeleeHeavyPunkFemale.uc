...
//
//-----------------------------------------------------------
class xMeleeHeavyPunkFemale extends HeavyMeleeFemaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.FemalePunk.FemalePunkHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.FemalePunk.FemalePunkBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.FemalePunk.FemalePunkBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.FemalePunk.FemalePunkBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.FemalePunk.FemalePunkBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.FemalePunk.FemalePunkBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.FemalePunk'
}
