...
//
//-----------------------------------------------------------
class xMeleeHeavyTeenagerFemale extends HeavyMeleeFemaleBase
placeable;

defaultproperties
{
     MeleeWeaponClass=Class'DOTZWeapons.BaseBallBatAttachment'
     MeleePickupClass=Class'DOTZWeapons.BaseBallBatPickup'
     ...
     HeadTextures(0)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.FemaleTeenager.FemaleTeenagerBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.FemaleTeenager'
}
