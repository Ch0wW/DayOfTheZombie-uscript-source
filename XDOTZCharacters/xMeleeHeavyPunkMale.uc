...
//
//-----------------------------------------------------------
class xMeleeHeavyPunkMale extends HeavyMeleeMaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MalePunk.MalePunkHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MalePunk.MalePunkBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MalePunk.MalePunkBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MalePunk.MalePunkBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MalePunk.MalePunkBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MalePunk.MalePunkBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MalePunk'
}
