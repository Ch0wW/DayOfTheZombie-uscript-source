...
//
//-----------------------------------------------------------
class xYoungAdultFemale extends StandardFemaleBase
placeable;

defaultproperties
{
     Names(0)="Zan Harriott"
     Names(1)="Nathalie Baudais"
     ...
     HeadTextures(0)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultHeadShaderJ'
     BodyTextures(0)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerA'
     BodyTextures(1)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerB'
     BodyTextures(2)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerC'
     BodyTextures(3)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerD'
     BodyTextures(4)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerE'
     BodyTextures(5)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerF'
     BodyTextures(6)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerG'
     BodyTextures(7)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerH'
     BodyTextures(8)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerI'
     BodyTextures(9)=Combiner'DOTZTZombies.FemaleYoungAdult.FemaleYoungAdultBodyCombinerJ'
     Mesh=SkeletalMesh'DOTZAZombies.FemaleYoungAdult'
}
