...
//
//-----------------------------------------------------------
class xMeleeHeavyHospitalPatientMale extends HeavyMeleeMaleBase
placeable;

defaultproperties
{
     MeleeWeaponClass=Class'DOTZWeapons.ShovelAttachment'
     MeleePickupClass=Class'DOTZWeapons.ShovelPickup'
     Names(0)="Daniel Yu"
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleHospitalPatient.MaleHospitalPatientBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleHospitalPatient'
}
