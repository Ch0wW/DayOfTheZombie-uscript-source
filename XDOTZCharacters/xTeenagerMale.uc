...
//
//-----------------------------------------------------------
class xTeenagerMale extends StandardMaleBase
placeable;
...
defaultproperties
{
     ...
     Affectations(0)=(BoneName="Head",item=Class'DOTZItems.TeenagerMaleHat')
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleTeenager.MaleTeenagerBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleTeenager'
}
