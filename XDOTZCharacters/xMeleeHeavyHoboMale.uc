...
//
//-----------------------------------------------------------
class xMeleeHeavyHoboMale extends HeavyMeleeMaleBase
placeable;
...
defaultproperties
{
     ...
     HeadTextures(0)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderA'
     HeadTextures(1)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderB'
     HeadTextures(2)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderC'
     HeadTextures(3)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderD'
     HeadTextures(4)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderE'
     HeadTextures(5)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderF'
     HeadTextures(6)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderG'
     HeadTextures(7)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderH'
     HeadTextures(8)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderI'
     HeadTextures(9)=Shader'DOTZTZombies.MaleHobo.MaleHoboHeadShaderJ'
     BodyTextures(0)=Shader'DOTZTZombies.MaleHobo.MaleHoboBodyShaderA'
     BodyTextures(1)=Shader'DOTZTZombies.MaleHobo.MaleHoboBodyShaderB'
     BodyTextures(2)=Shader'DOTZTZombies.MaleHobo.MaleHoboBodyShaderC'
     BodyTextures(3)=Shader'DOTZTZombies.MaleHobo.MaleHoboBodyShaderD'
     BodyTextures(4)=Shader'DOTZTZombies.MaleHobo.MaleHoboBodyShaderE'
     Mesh=SkeletalMesh'DOTZAZombies.MaleHobo'
}
