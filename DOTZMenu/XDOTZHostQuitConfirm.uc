 ...
 * @date    Sept 2003
 */
class XDOTZHostQuitConfirm extends XDOTZErrorPage;
...
defaultproperties
{
     QuitMessage="Leaving the game now will end this session. Are you sure you want to leave?"
     quit_string="Quit"
     __OnKeyEvent__Delegate=XDOTZHostQuitConfirm.HandleKeyEvent
}
