...
class XDOTZLiveFriendSentInv extends XDOTZLiveFriendBase;
...
defaultproperties
{
     Begin Object Class=GUIButton Name=RemoveFriend_btn
         ...
         TabOrder=1
         bFocusOnWatch=True
         __OnClick__Delegate=XDOTZLiveFriendSentInv.ButtonClicked
         Name="RemoveFriend_btn"
     End Object
     RemoveFriend=GUIButton'DOTZMenu.XDOTZLiveFriendSentInv.RemoveFriend_btn'
     Message="What do you want to do with this friend?"
     ClickSound=Sound'DOTZXInterface.Select'
     Background=Texture'DOTZTInterface.Menu.SettingsBackground'
     __OnKeyEvent__Delegate=XDOTZLiveFriendSentInv.HandleKeyEvent
}
