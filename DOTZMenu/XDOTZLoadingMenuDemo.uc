...
//
//-----------------------------------------------------------
class XDOTZLoadingMenuDemo extends XDOTZPageBase;
...
defaultproperties
{
     ...
     End Object
     LoadingMsgBox=GUILabel'DOTZMenu.XDOTZLoadingMenuDemo.Loading_control'
     Begin Object Class=GUILabel Name=Fact_control
         ...
         Name="Fact_control"
     End Object
     FactMsgBox=GUILabel'DOTZMenu.XDOTZLoadingMenuDemo.Fact_control'
     ...
     facts2(5)="Always close doors behind you. Although the withered will eventually break though, this slows them down significantly and lets you hear them coming."
     ...
     bAllowedAsLast=True
     WinHeight=1.000000
     __OnKeyEvent__Delegate=XDOTZLoadingMenuDemo.HandleKeyEvent
}
