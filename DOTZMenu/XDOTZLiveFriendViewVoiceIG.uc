...
class XDOTZLiveFriendViewVoiceIG extends XDOTZLiveFriendBaseIG;
...
defaultproperties
{
     Begin Object Class=GUIButton Name=PlayVoiceAttachment_btn
         ...
         TabOrder=1
         bFocusOnWatch=True
         __OnClick__Delegate=XDOTZLiveFriendViewVoiceIG.ButtonClicked
         Name="PlayVoiceAttachment_btn"
     End Object
     PlayVoiceAttachment=GUIButton'DOTZMenu.XDOTZLiveFriendViewVoiceIG.PlayVoiceAttachment_btn'
     ...
     End Object
     OffensiveMessageFeedback=GUIButton'DOTZMenu.XDOTZLiveFriendViewVoiceIG.OffensiveMessageFeedback_btn'
     Message="What do you want to do with the voice mail attachment?"
     ...
     __OnKeyEvent__Delegate=XDOTZLiveFriendViewVoiceIG.HandleKeyEvent
}
