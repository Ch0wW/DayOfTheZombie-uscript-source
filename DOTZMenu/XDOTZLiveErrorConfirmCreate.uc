...
//
//-----------------------------------------------------------
class XDOTZLiveErrorConfirmCreate extends XDOTZErrorPage;
...
function DoButtonA ()
{
    class'UtilsXbox'.static.Do_Create_Account();
}
...
defaultproperties
{
     ...
     __OnKeyEvent__Delegate=XDOTZLiveErrorConfirmCreate.HandleKeyEvent
}
