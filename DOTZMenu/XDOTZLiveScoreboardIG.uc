...
//
//-----------------------------------------------------------
class XDOTZLiveScoreboardIG extends XDOTZLivePlayersListIG;
...
defaultproperties
{
     ...
     End Object
     EndGameLabel=GUILabel'DOTZMenu.XDOTZLiveScoreboardIG.EndGameLabel_lbl'
     endGameMsg="Match over. Restarting map."
     ...
     __OnKeyEvent__Delegate=XDOTZLiveScoreboardIG.HandleKeyEvent
}
