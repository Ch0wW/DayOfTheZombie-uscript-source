...
//
//-----------------------------------------------------------
class XDOTZPlayingVoiceMail extends XDOTZErrorPage;
...
event Opened( GUIComponent Sender ) {
   ...
   class'UtilsXbox'.static.VoiceChat_Play_Voice_Mail();
}
...
defaultproperties
{
     ...
     Begin Object Class=GUIImage Name=BarFront_icn
         ...
         Name="BarFront_icn"
     End Object
     BarFront=GUIImage'DOTZMenu.XDOTZPlayingVoiceMail.BarFront_icn'
     error_string="Playing Voice Mail attachment. Press B to cancel."
     period=0.100000
     __OnKeyEvent__Delegate=XDOTZPlayingVoiceMail.HandleKeyEvent
}
