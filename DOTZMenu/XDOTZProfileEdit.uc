...
class XDOTZProfileEdit extends XDOTZProfileBase;
...
var string ProfileEditSettingsMenu;         // Profile menu location
...
function bool ButtonClicked(GUIComponent Sender) {
    ...
    switch (Selected) {
        case ProfileList:
             ...
             DOTZPlayerControllerBase(PlayerOwner()).LoadProfile(list_item);
             Controller.OpenMenu(ProfileEditSettingsMenu);
             break;
    };  */
...
defaultproperties
{
     Begin Object Class=BBXListBox Name=ProfileList_btn
         ...
         WinWidth=0.800000
         WinHeight=0.600000
         __OnClick__Delegate=XDOTZProfileEdit.ButtonClicked
         Name="ProfileList_btn"
     End Object
     ProfileList=BBXListBox'DOTZMenu.XDOTZProfileEdit.ProfileList_btn'
     PageCaption="Edit Profile"
     ProfileEditSettingsMenu="DOTZMenu.XDOTZProfileEditSettings"
     ClickSound=Sound'DOTZXInterface.Select'
     Background=Texture'DOTZTInterface.Menu.SettingsBackground'
     __OnKeyEvent__Delegate=XDOTZProfileEdit.HandleKeyEvent
}
