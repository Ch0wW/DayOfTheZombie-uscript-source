...
//
//-----------------------------------------------------------
class XDOTZLiveCancelFriendReq extends XDOTZErrorPage;
...
defaultproperties
{
     ...
     error_string="Do you really want to cancel the friend request? Press A to accept or B to cancel."
     __OnKeyEvent__Delegate=XDOTZLiveCancelFriendReq.HandleKeyEvent
}
