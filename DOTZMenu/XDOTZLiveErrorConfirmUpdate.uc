...
//
//-----------------------------------------------------------
class XDOTZLiveErrorConfirmUpdate extends XDOTZErrorPage;
...
function DoButtonA ()
{
    class'UtilsXbox'.static.Do_Auto_Update();
}
...
defaultproperties
{
     ...
     __OnKeyEvent__Delegate=XDOTZLiveErrorConfirmUpdate.HandleKeyEvent
}
