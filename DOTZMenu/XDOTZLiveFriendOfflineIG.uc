...
class XDOTZLiveFriendOfflineIG extends XDOTZLiveFriendBaseIG;
...
defaultproperties
{
     Begin Object Class=GUIButton Name=InviteFriend_btn
         ...
         WinHeight=0.080000
         bFocusOnWatch=True
         __OnClick__Delegate=XDOTZLiveFriendOfflineIG.ButtonClicked
         Name="InviteFriend_btn"
     End Object
     InviteFriend=GUIButton'DOTZMenu.XDOTZLiveFriendOfflineIG.InviteFriend_btn'
     ...
     End Object
     RemoveFriend=GUIButton'DOTZMenu.XDOTZLiveFriendOfflineIG.RemoveFriend_btn'
     Message="What do you want to do with this friend?"
     ClickSound=Sound'DOTZXInterface.Select'
     Background=Texture'DOTZTInterface.Menu.SettingsBackground'
     __OnKeyEvent__Delegate=XDOTZLiveFriendOfflineIG.HandleKeyEvent
}
