...
//
//-----------------------------------------------------------
class XDOTZLiveErrorConfirmManagement extends XDOTZErrorPage;
...
function DoButtonA ()
{
    class'UtilsXbox'.static.Do_Management();
}
...
defaultproperties
{
     ...
     __OnKeyEvent__Delegate=XDOTZLiveErrorConfirmManagement.HandleKeyEvent
}
