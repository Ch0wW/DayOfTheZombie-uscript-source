...
class XDOTZLiveFriendsListBaseIG extends XDOTZLiveInGamePage;

/* NOTE: KEEP THIS CLASS THE SAME AS XDOTZLiveFriendsListBase */
...
var Material icon_voice_through_tv;
...
function VoiceStatus Get_Voice_Status_Players () {

    // Check if No voice or Banned
    if ( class'UtilsXbox'.static.VoiceChat_Is_Banned ())
        return VOICE_NONE;
    ...
    if (!class'UtilsXbox'.static.VoiceChat_Is_Enabled() )
        return VOICE_NONE;

    // If talking
    else if ( class'UtilsXbox'.static.VoiceChat_Is_Talking () )
        return VOICE_TALKING;
...
function Material Get_Voice_Status_Material_Players () {
    local VoiceStatus voice_status;

    // Figure out voice part
    voice_status = Get_Voice_Status_Players();
    switch (voice_status) {
        case VOICE_NONE:        return None;
        case VOICE_ON:          return icon_voice_on;
        case VOICE_MUTED:       return icon_voice_muted;
        case VOICE_THROUGH_TV:  return icon_voice_through_tv;
        case VOICE_TALKING:     return icon_voice_talking;
    };
...
defaultproperties
{
     ...
     icon_voice_through_tv=Texture'DOTZTInterface.XBoxIcons.NoVoice'
