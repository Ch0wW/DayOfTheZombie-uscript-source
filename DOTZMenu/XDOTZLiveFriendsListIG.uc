...
class XDOTZLiveFriendsListIG extends XDOTZLiveFriendsListBaseIG;
...
function bool ButtonClicked(GUIComponent Sender) {
    ...
    switch (Selected) {
        case FriendsList:
            ...
            // Extract the XUID and select it's messages
            ...
            if ( class'UtilsXbox'.static.Friends_Get_Gamer_Tag() != "" ) {
                ...
                switch (friend_status) {
                    ...
                    case ONLINE_PLAYING:                 Controller.OpenMenu("DOTZMenu.XDOTZLiveFriendPlayingIG"); break;
                    case ONLINE_PLAYING_JOINABLE:        Controller.OpenMenu("DOTZMenu.XDOTZLiveFriendPlayingIG"); break;
...
defaultproperties
{
     Begin Object Class=BBXListBox Name=FriendsList_btn
         ...
         WinWidth=0.900000
         WinHeight=0.620000
         __OnClick__Delegate=XDOTZLiveFriendsListIG.ButtonClicked
         Name="FriendsList_btn"
     End Object
     FriendsList=BBXListBox'DOTZMenu.XDOTZLiveFriendsListIG.FriendsList_btn'
     ...
     End Object
     GamertagLabel=GUILabel'DOTZMenu.XDOTZLiveFriendsListIG.GamertagLabel_lbl'
     ...
     End Object
     GamertagField=GUILabel'DOTZMenu.XDOTZLiveFriendsListIG.GamertagFieldLabel_lbl'
     ...
     End Object
     StatusLabel=GUILabel'DOTZMenu.XDOTZLiveFriendsListIG.StatusLabel_lbl'
     ...
     End Object
     StatusField=GUILabel'DOTZMenu.XDOTZLiveFriendsListIG.StatusFieldLabel_lbl'
     PageCaption="Friends"
     ClickSound=Sound'DOTZXInterface.Select'
     Background=Texture'DOTZTInterface.Menu.SettingsBackground'
     __OnKeyEvent__Delegate=XDOTZLiveFriendsListIG.HandleKeyEvent
}
