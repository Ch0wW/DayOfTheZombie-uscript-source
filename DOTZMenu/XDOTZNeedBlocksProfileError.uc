...
//
//-----------------------------------------------------------
class XDOTZNeedBlocksProfileError extends XDOTZErrorPage;
...
defaultproperties
{
     ...
     error_string1="Your Xbox console doesn't have enough free blocks to create a profile. You need"
     error_string2="more free blocks. Press A to continue or B to free more blocks."
     __OnKeyEvent__Delegate=XDOTZNeedBlocksProfileError.HandleKeyEvent
}
