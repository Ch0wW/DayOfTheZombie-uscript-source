...
//
//-----------------------------------------------------------
class XDOTZLiveFriendVoiceMailOptionIG extends XDOTZLiveFriendBaseIG;
...
function bool ButtonClicked(GUIComponent Sender) {
    ...
    switch (Selected) {
        case Yes_Button:
            BBGuiController(Controller).SwitchMenu("DOTZMenu.XDOTZLiveFriendSendInviteVoiceIG");
            return false; break;
...
defaultproperties
{
     ...
     Begin Object Class=GUIButton Name=Yes_Button_btn
         ...
         TabOrder=1
         bFocusOnWatch=True
         __OnClick__Delegate=XDOTZLiveFriendVoiceMailOptionIG.ButtonClicked
         Name="Yes_Button_btn"
     End Object
     Yes_Button=GUIButton'DOTZMenu.XDOTZLiveFriendVoiceMailOptionIG.Yes_Button_btn'
     Begin Object Class=GUIButton Name=No_Button_btn
         ...
         Name="No_Button_btn"
     End Object
     No_Button=GUIButton'DOTZMenu.XDOTZLiveFriendVoiceMailOptionIG.No_Button_btn'
     Message="Do you want to send a voice mail attachment?"
     Background=Texture'DOTZTInterface.Menu.SettingsBackground'
     __OnKeyEvent__Delegate=XDOTZLiveFriendVoiceMailOptionIG.HandleKeyEvent
}
